...
public class LionKingRecyclerAdapter extends RecyclerView.Adapter<LionKingRecyclerAdapter.UserViewHolder> {
    private final List<SearchItem> searchItemsList;
   IUserAdapterCommunicator iUserAdapterCommunicator;

    public LionKingRecyclerAdapter(List<SearchItem> searchItems, IUserAdapterCommunicator iUserAdapterCommunicator)
    {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       // View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_userdata,parent,false);
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lionking,parent,false);
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserViewHolder(View view)
        {
            super(view);
            root = view;
            logo = view.findViewById(R.id.iv_lposter);
            title = view.findViewById(R.id.tv_ltitle);
            type = view.findViewById(R.id.tv_ltype);
            date = view.findViewById((R.id.tv_lyear));
            imDb = view.findViewById(R.id.tv_limdbId);
